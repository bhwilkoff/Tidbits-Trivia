...
| Rolling named-scenario health regression | `roll1-*` re-runs on the current build | ✅ 2026-08-24 late: a FULL roll2 lap — all 12 named scenarios green consecutively on the final build (home, classic, picture-round, daily, night-host, night-join-crossplatform, versus-ace, quickmatch, records, settings, create, paywall; `roll2-*` dirs), plus the earlier roll1 set |
