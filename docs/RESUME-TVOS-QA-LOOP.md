...
- **Rolling-health mode**: **EIGHTEEN consecutive full 12-scenario laps green**
  (roll2–roll19). **Lap 20 is next, starting at `home`**
  ...
  lap-closing **Chrome multiplayer loop** (below), passed 11×. Host the night WITH
