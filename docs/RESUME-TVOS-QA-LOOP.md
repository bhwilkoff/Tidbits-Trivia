...
- **Rolling-health mode**: **SEVENTEEN consecutive full 12-scenario laps green**
  (roll2–roll18). **Lap 19 is next, starting at `home`**
  ...
  lap-closing **Chrome multiplayer loop** (below), passed 10×. Host the night WITH
