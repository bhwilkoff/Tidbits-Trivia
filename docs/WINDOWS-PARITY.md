...
- [ ] 3.39 Question editor: picture field + "Choose picture…" into the store; per-question audio/video attach (LIVE-PACKAGE-FORMAT §8.1). The dialog has no picture field at all today
