...
- [~] 2.5 Play/Home surface — Quick Play hero (now replays last mode+cat via GameSettings memory, 0.4) + **Surprise Me (random mode+cat)** + Daily + category picker + mode grid; Online-MP pending
