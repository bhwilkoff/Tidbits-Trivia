...
- **Rolling-health mode**: **TWENTY consecutive full 12-scenario laps green**
  (roll2–roll21). **Lap 22 is next, starting at `home`**
  ...
  lap-closing **Chrome multiplayer loop** (below), passed 13×. Host the night WITH
