...
- [~] 2.8 Per-mode answer surfaces — numeric slider (Closest Call), free-text (Name It), Stake (chip budget + dimmed MCQ until committed), and In Order (▲/▼ reorder) built + PNG-verified + play-through tests GREEN; Sweep/Ladder/OddOneOut/ThisOrThat ride MCQ. Matching/enumerate/picture pending
