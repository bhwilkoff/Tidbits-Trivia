...
| Which First? / This-or-That (chronology) | ✅ | ✅ | ✅ | ✅ | 10-Q binary pick off E1 chronology (`thisorthat.json`, 613 Qs): "Which came first?" between two same-category entities (verified 0 chronology errors). Renders on the existing 2-option MCQ surface. Size comparisons (population/area) deferred until enrich.py picks the best numeric claim. SOLO-BACKLOG Q1 |
