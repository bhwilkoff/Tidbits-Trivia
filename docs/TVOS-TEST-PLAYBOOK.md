...
| Rolling named-scenario health regression | `roll1-*` re-runs on the current build | ✅ 2026-08-24 evening: home, classic, picture-round, daily, night-host all green on the day's final build |
