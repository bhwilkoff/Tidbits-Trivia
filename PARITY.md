...
| Social graph — friends leaderboard filter (L5, 2026-07-04) | ✅ | ✅ | ⏳ | ✅ | Shipped 1.6.34 (web/iOS/Android). The leaderboard leads with a "Friends" section — your added people ranked by their standing from the already-public overall board (you highlighted, "—" for those not yet on the board). Friends stay private; only their public standings are read. tvOS ⏳ (the Core friend store is there; the tvOS board's Friends section isn't added yet) |
