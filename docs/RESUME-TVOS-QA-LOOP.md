...
- **Rolling-health mode**: **SIXTEEN consecutive full 12-scenario laps green**
  (roll2–roll17). **Lap 18 is next, starting at `home`**
  ...
  lap-closing **Chrome multiplayer loop** (below), passed 9×. Host the night WITH
